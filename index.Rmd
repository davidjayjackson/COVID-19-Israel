...
date: :June 1, 2020 6:00 21:56 UT/UD"
...
ECDC %>% ggplot() + geom_col(aes(x=Reported,y=Cases)) +
  labs(title="Total Cases: Israel's fight with COVID-19",x="Date Reported",y="Total Cases Reported")

ECDC %>% ggplot() + geom_col(aes(x=Reported,y=Deaths)) +
  labs(title="Total Deaths: Israel's fight with COVID-19",x="Date Reported",y="Total Deaths Reported")
