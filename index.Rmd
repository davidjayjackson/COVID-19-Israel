...
plot(US$Reported,US$Cases,type="l",main=" COVID-19 Cases Apr. 1,2020 - Aug. 22, 2020",
     xlab="Date Reported",ylab="Cases")
lines(US$Reported,US$MA14,col="red")
grid(col="black")
```
```{r}
US <- subset(df,Reported >="2020-04-01" & Reported <="2020-08-22")
US$Deaths14 <- movingAverage(US$Deaths,14)
plot(US$Reported,US$Deaths,type="l",main="COVID-19 Deaths Apr. 1,2020 - Aug. 22, 2020",
