---
title: 'Israel Battle with COVID'
...
df <- subset(df,Countries =="Israel" & Cases >0 )
...
plot(US$Reported,US$Cases,type="l",main="Isreal COVID-19 Cases Apr. 1,2020 - Aug. 12, 2020")
...
plot(US$Reported,US$Deaths,type="l",main="Israel COVID-19 Deaths Apr. 1,2020 - Aug. 12, 2020")
...
```
```{r}
barplot(Cases ~Weekly,data=Weekly_Cases,main="Israel Weekly Barplot of Cases")
grid(col="black")
barplot(Deaths ~Weekly,data=Weekly_Deaths,main="Israel Weekly Barplot of Deaths")
grid(col="black")
```
```{r}
...
```
```{r}
barplot(Cases ~Monthly,data=Monthly_Cases,main="Israel Monthly Barplot of Total Cases")
grid(col="black")
barplot(Deaths ~Monthly,data=Monthly_Deaths,main="Israel Monthly Barplot of Total Deaths")
grid(col="black")
```
...
```
```{r}
barplot(Cases ~Weekly,data=Weekly_Cases,main="Israel Weekly Barplot of Mean Cases")
grid(col="black")
barplot(Deaths ~Weekly,data=Weekly_Deaths,main="Israel Weekly Barplot of Mean Deaths")
grid(col="black")
```
```{r}
...
```
```{r}
barplot(Cases ~Monthly,data=Monthly_Cases,main="Israel Monthly Mean Barplot of Cases")
grid(col="black")
barplot(Deaths ~Monthly,data=Monthly_Deaths,main="Israel Monthly Mean Barplot of Deaths")
grid(col="black")
```
