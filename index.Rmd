...
## Israel Battle with Covid-19 (365 Day Window)
...
df <- subset(df,location =="Israel" & date >=Sys.Date() -365 )
...
US$MAC <- movavg(US$new_cases,7,type = "w")
US$MAD <- movavg(US$new_deaths,7,type = "w")
