...
```
```{r}
# US <- subset(df,Reported <="2020-04-31")
summary(df$Cases)
summary(df$Deaths)
df$MA14 <- movingAverage(df$Cases,14)
plot(df$Reported,df$Cases,type="l",main=" COVID-19 Cases Apr. 1,2020 - Aug. 31, 2020",
...
plot(df$Reported,df$Deaths,type="l",main="COVID-19 Deaths Apr. 1,2020 - Aug. 26, 2020",
